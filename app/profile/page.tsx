              ...
              <Card className="glass">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start space-x-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-3 border-blue-500">
                    ...
                    <div className="flex items-start space-x-2 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border-l-3 border-green-500">
                    ...
                    <div className="flex items-start space-x-2 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border-l-3 border-yellow-500">
